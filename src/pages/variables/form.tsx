  ...
  return (
    <>
      <div className="space-y-0.5">
        <h2 className="text-2xl font-bold tracking-tight">Create variable</h2>
        <p className="text-muted-foreground">
          Add new variable to your system.
        </p>
      </div>
      ...
      <div className="mx-auto grid w-full items-start gap-6 md:grid-cols-[150px_1fr] ">
        <nav className="flex md:flex-col gap-4 text-muted-foreground">
          ...
          <NavLink to="#" className="font-semibold text-primary p-2 rounded">
            Image
          </NavLink>
        </nav>
